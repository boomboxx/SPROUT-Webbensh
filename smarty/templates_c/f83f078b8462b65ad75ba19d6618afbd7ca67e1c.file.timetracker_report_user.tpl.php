<?php /* Smarty version Smarty-3.0.7, created on 2011-07-15 18:12:16
         compiled from "C:/xampp/htdocs/Projekte/000_001-autoactiva-zeittracker/Dev/smarty/templates\modules/projects/timetracker_report_user.tpl" */ ?>
<?php /*%%SmartyHeaderCode:213184e2066e03321a2-27610187%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f83f078b8462b65ad75ba19d6618afbd7ca67e1c' => 
    array (
      0 => 'C:/xampp/htdocs/Projekte/000_001-autoactiva-zeittracker/Dev/smarty/templates\\modules/projects/timetracker_report_user.tpl',
      1 => 1310746235,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '213184e2066e03321a2-27610187',
  'function' => 
  array (
  ),
...
<br />
<br />
<form method="post" action="index.php?page=timetrackerReportUser">
	Datum: <input type="text" name="trackreportUserDate" class="trackreportUserDate datepickerUi" value="<?php if (isset($_smarty_tpl->getVariable('pageRequest',null,true,false)->value['trackreportUserDate'])){?><?php echo $_smarty_tpl->getVariable('pageRequest')->value['trackreportUserDate'];?>
<?php }else{ ?><?php echo $_smarty_tpl->getVariable('module')->value->getDateToday();?>
<?php }?>" />
	<input type="submit" name="trackerreportDateSumbit" value="aktualisieren" />
</form>
<br />
<br />
