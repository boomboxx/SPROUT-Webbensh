<?php /* Smarty version Smarty-3.0.7, created on 2011-08-24 08:17:23
         compiled from "F:/xamppWin7/xampp/htdocs/projekte/BBX - Boomboxx/BBX1103-SWB - Sprout 0.2/Dev/smarty/templates\modules/projects/timetracker_report_default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:273224e549773cdddb3-87918276%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b6bfa7fb5da50060ebe226b80df3485318fccee7' => 
    array (
      0 => 'F:/xamppWin7/xampp/htdocs/projekte/BBX - Boomboxx/BBX1103-SWB - Sprout 0.2/Dev/smarty/templates\\modules/projects/timetracker_report_default.tpl',
      1 => 1314166634,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '273224e549773cdddb3-87918276',
  'function' => 
  array (
  ),
...
<form method="post" action="index.php?page=timetrackerReportDefault">
	<input type="text" name="trackreportDefaultDate" class="datepickerUi" value="<?php echo $_smarty_tpl->getVariable('module')->value->getDateToday();?>
" />
	Kunde: 
...
<?php }else{ ?>-<?php }?>
		...
		<td class="right-align">
			<?php if ($_smarty_tpl->getVariable('trackingsSums')->value['sumNettoSeconds']>0){?><?php echo $_smarty_tpl->getVariable('trackingsSums')->value['sumNettoSeconds'];?>
<?php }else{ ?>-<?php }?>
		</td>
	</tr>	
</table>
